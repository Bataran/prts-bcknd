...
<div class="row">
  ...
  <div id="versions"></div>
    ...
    <li class="depth-4">
      <a href="#418">constructor</a>
    </li>
  
    <li class="depth-4">
      <a href="#450">component</a>
    </li>
  
    <li class="depth-4">
      <a href="#422">controller</a>
    </li>
  
    <li class="depth-4">
      <a href="#435">getServer</a>
    </li>
    ...
    <li class="depth-3">
      <a href="#398">Function: mountComponent</a>
    </li>
  
    <li class="depth-3">
      <a href="#499">Function: promisify</a>
    </li>
...
and models.</p>
    ...
    <h4 class="code-ref">constructor(options: <a href="#ApplicationConfig">ApplicationConfig</a>) : Application</h4>
...
and models.</p>
    ...
    <h4 class="code-ref">component(componentCtor: <a href="#Constructor">Constructor</a>, name: string) : void</h4>
...
controllers, providers, and servers from the component.</p>
    ...
    <table class="params code-arguments">
        <tr>
            ...
            <tr class="code-arg">
                <td>
                    <strong class="code-arg-name">componentCtor</strong>
                </td>
                <td class="code-arg-types">
...
-->
    ...
    <div class="code-desc">
        <p></p>
        <p><p><p>Optional component name, default to the class name</p></p>
<pre><code class="lang-ts">
export class ProductComponent {
  controllers = [ProductController]<span class="comment">;</span>
  repositories = [ProductRepo, UserRepo]<span class="comment">;</span>
  providers = {
...
app<span class="preprocessor">.component</span>(ProductComponent)<span class="comment">;</span></code></pre>
</p>
    </div>
    ...
    <h4 class="code-ref">controller(controllerCtor: <a href="#ControllerClass">ControllerClass</a>, name: string) : Binding</h4>
...
-->
    ...
    <h4 class="code-ref">getServer(target: undefined) : Promise</h4>
...
and models.</p>
    ...
    <h4 class="code-ref">server(ctor: <a href="#Constructor">Constructor</a>, name: string) : Binding</h4>
...
to prevent binding overlap.</p>
        ...
        <p><pre><code class="lang-ts"><span class="title">app</span>.server(<span class="type">RestServer</span>);
// <span class="type">This</span> server constructor will be bound under <span class="string">"servers.RestServer"</span>.
<span class="title">app</span>.server(<span class="type">RestServer</span>, <span class="string">"v1API"</span>);
// <span class="type">This</span> server <span class="class"><span class="keyword">instance</span> will be bound under "servers.v1API".</code></pre>
</p>
    </div>
...
-->
    ...
    <h4 class="code-ref">servers(ctors: undefined) : </h4>
...
class constructor name with the &quot;servers.&quot; prefix.</p>
        ...
        <p><p><p>If you wish to control the binding keys for particular server instances,
use the app.server function instead.</p></p>
<pre><code class="lang-ts">app.servers([
 <span class="constant">RestServer</span>,
 <span class="constant">GRPCServer</span>,
]);
<span class="regexp">//</span> <span class="constant">Creates</span> a binding <span class="keyword">for</span> <span class="string">"servers.RestServer"</span> <span class="keyword">and</span> a binding <span class="keyword">for</span>
/<span class="regexp">/ "servers.GRPCServer";</code></pre>
</p>
    </div>
    ...
    <table class="params code-arguments">
        <tr>
            ...
            <tr class="code-arg">
                <td>
                    <strong class="code-arg-name">ctors</strong>
                </td>
                <td class="code-arg-types">
    ...
    <table class="params code-arguments">
        <tr>
            ...
            <tr class="code-arg">
                <td>
                    <a name="ApplicationConfig"></a>
                    <strong class="code-arg-name">components</strong>
                </td>
                <td class="code-arg-types">
...
-->
    ...
    <div class="code-desc">
        <p><p>An array of component classes</p>
</p>
        <p></p>
    </div>
            ...
            <tr class="code-arg">
                <td>
                    <a name="ApplicationConfig"></a>
                    <strong class="code-arg-name">controllers</strong>
                </td>
                <td class="code-arg-types">
    ...
    <div class="code-desc">
        ...
        <p></p>
            ...
            <tr class="code-arg">
                <td>
                    <a name="ApplicationConfig"></a>
                    <strong class="code-arg-name">servers</strong>
                </td>
                <td class="code-arg-types">
...
-->
    ...
    <div class="code-desc">
        <p><p>A map of server name/class pairs</p>
</p>
        <p></p>
    </div>
    ...
    <div class="code-desc">
        ...
        <p></p>
            ...
            <tr class="code-arg">
                <td>
                    <a name="Component"></a>
                    <strong class="code-arg-name">providers</strong>
                </td>
                <td class="code-arg-types">
...
-->
    ...
    <div class="code-desc">
        ...
        <p></p>
            ...
            <tr class="code-arg">
                <td>
                    <strong class="code-arg-name">component</strong>
                </td>
                <td class="code-arg-types">
...
<section class="code-doc ">
    ...
    <h4 class="code-ref">promisify(func: (callback: (err: any, result: T) => void) => void) : </h4>
...
-->
    ...
    <div class="code-desc">
        <p><p>Polyfill promisify and use <code>util.promisify</code> if available</p>
</p>
        <p></p>
    </div>
    ...
    <table class="params code-arguments">
        <tr>
            ...
            <tr class="code-arg">
                <td>
                    <strong class="code-arg-name">func</strong>
                </td>
                <td class="code-arg-types">
...
-->
    ...
    <div class="code-desc">
        <p><p>A callback-style function</p>
</p>
        <p></p>
    </div>
