...
import { SearchableResource, CreatableResource, UpdatableResource, DeletableResource } from './templates';
...
const userUpdatableResource = UpdatableResource({
  controller: "UserController",
  path: "users",
}, "User");

const userDeletableResource = DeletableResource({
  controller: "UserController",
  path: "users",
}, "User");
...
_.merge(userApiSpec,
  ResourceDefinition(BaseDefinition, UserDefinition),
  userGetResource,
  userCreateResource,
  userUpdatableResource,
  userDeletableResource);
